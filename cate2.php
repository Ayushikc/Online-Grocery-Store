...
<script type="text/javascript">
	...
	<style type="text/css">
		...
		a.back-to-top{
	background: url("imgs/up-arrow.png") no-repeat center 43%;
	}
	.kishan a
{
  color: red;
...
<div id="navbar">
	<ul>
		...
		<li><a class="active" href="cate2.php">Fruits & Vegetables</a></li>
		<li><a href="cate3.php">Bakery & Dairy</a></li>		
		<form action = "search.php" method= "POST">

		<input class = "search" type="hidden" name = "category" value="Fruits & Vegetables">
...
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products where category='Fruits & Vegetables' ORDER BY id ASC limit $page1,5");
if($results){ 
...
$res = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products where category='Fruits & Vegetables'");
...
for($b=1;$b<=$a;$b++)
{
  ?><div class='kishan'><a href="cate2.php?page=<?php echo $b; ?>"style="text-decoration: underline"><?php echo $b." "; ?></a></div><?php
}
//mysqli_close($conn);
?>
</div>
