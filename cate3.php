...
<div id="navbar">
	<ul>
		...
		<li><a class="active" href="cate3.php">Bakery & Dairy</a></li>	
		<form action = "search.php" method= "POST">

		<input class = "search" type="hidden" name = "category" value="Bakery & Dairy">
...
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE category='Bakery & Dairy'ORDER BY id ASC limit $page1,5");
if($results){ 
...
$res = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products where category='Bakery & Dairy'");
...
for($b=1;$b<=$a;$b++)
{
  ?><div class='kishan'><a href="cate3.php?page=<?php echo $b; ?>"style="text-decoration: underline"><?php echo $b." "; ?></a></div><?php
}
//mysqli_close($conn);
?>
</div>
