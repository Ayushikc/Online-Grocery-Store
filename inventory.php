...
<html>
<head>
	<title>Inventory | Online Grocery Shopping</title>
...
<?php
$results = $mysqli->query("SELECT id,product_code, product_name, category, dept, price, product_qty FROM products  ORDER BY id ASC");
if($results){ 
$products_item = '<table border="1" bordercolor="white" style="color:white;"><th>ID</th><th>Product Code</th><th>Category</th><th>Department</th><th>Product Name</th><th>Price</th><th>Product Quantity</th>
...
$products_item .= <<<EOT
    ...
    <td><p align="center">{$obj->dept}</p></td>
